        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse">
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item">
                        <span class="nav-link text-light">Hi Holder !</span>
                    </li>
                </ul>
            </div>
        </div>
                            ...
                            <div class="card shadow border">
                                ...
                                <div class="card-body bg-transparent p-0">
                                    <ul id="liste-etape" class="list-group bg-transparent m-0">
                                        ...
                                        <li class="list-group-item text-center bg-transparent">Etape_AB_004</li>
                                        <li class="list-group-item text-center bg-transparent">Etape_AB_005</li>
                                        <li class="list-group-item text-center bg-transparent">Etape_AB_006</li>
                                        <li class="list-group-item text-center bg-transparent">Etape_AB_007</li>
                                        <li class="list-group-item text-center bg-transparent">Etape_AB_008</li>
                                        <li class="list-group-item text-center bg-transparent">Etape_AB_009</li>
                                        <li class="list-group-item text-center bg-transparent">Etape_AB_010</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-3 m-0 p-0">
                            <nav id="etapes-sidbar" class="nav flex-column m-0 p-0 border shadow bg-white">
                                ...
                                <ul class="list-unstyled">
                                    <li>
                                        <a href="#first-collapse" class="btn btn-block custom-btn etape-btn text-dark"
                                    ...
                                    <li>
                                        <a href="#second-collapse" class="btn btn-block custom-btn etape-btn text-dark"
                                    ...
                                    <li>
                                        <a href="#third-collapse" class="btn btn-block custom-btn etape-btn text-dark"
                                    ...
                                    <li>
                                        <a href="#fourth-collapse" class="btn btn-block custom-btn etape-btn text-dark"
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                <form action="UpdateEtat" class="d-flex justify-content-between">
                                                    <input type="submit" name="valider" class="btn btn-outline-success"
                                                        value="Valider">
                                                    <input type="submit" name="refuser" class="btn btn-outline-warning"
                                                        value="refuser">
                                                    <input type="submit" name="rejeter" class="btn btn-outline-danger"
                                                        value="rejeter">
                                                </form>
                                            </div>
